...
// ============================================================================================= 
// ค่อยกลับมาโหลด env เพื่อใช้ ===============================
// require("dotenv").config();

// console.log("Current directory:", process.cwd());
// console.log("LIFF_URL:", process.env.LIFF_URL);
// console.log("TOKEN:", !!process.env.CHANNEL_ACCESS_TOKEN);
// const CHANNEL_ACCESS_TOKEN = process.env.CHANNEL_ACCESS_TOKEN
// const LIFF_URL = process.env.LIFF_URL

// const LIFF_URL_MYTICKET = `${LIFF_URL}?redirect=/my-tickets`
// =============================================================================================
...
const LIFF_URL_MYTICKET = `${LIFF_URL}?redirect=/my-tickets`; // rich ช่องติดตามสถานะ แต่เป็น LIFF ID เดียวกัน
    ...
    const richMenu = {
      ...
      areas: [
        ...
        },
        {
          ...
          action: {
            type: "uri",
            text: "ติดตามสถานะแจ้งซ่อม",
            uri: LIFF_URL_MYTICKET
          }
        },
        {
